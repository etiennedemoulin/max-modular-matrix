...
function generateMatrix() {
  ...
  // generateBox('matrix_unpack', 'mc.combine~', [globals.routingMatrix.inputs.length], { x: 20, y:30 }, 0);
  // generateBox('matrix_pack', 'mc.separate~', [globals.routingMatrix.outputs.length], { x: 20, y:280 }, 0);
...
function onRouting(row, col, gain) {
  ...
  // console.log(userMatrixInput, globals.userMatrix.inputs)
